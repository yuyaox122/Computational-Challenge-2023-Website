<template>
    <div class="overflow-y-scroll scroll-smooth">
        ...
        <section
            class="overflow-hidden container flex items-center justify-center h-screen m-auto mb-12 bg-fixed bg-center bg-cover custom-img">
        ...
        <section class="overflow-hidden container flex items-center justify-center m-auto mb-12 h-screen bg-fixed bg-cover bg-[url('src/assets/TapestryOfBlazingStarbirth.jpg')]">
            <img src="src\assets\task_1_code.png" class="rounded-lg mx-auto max-w-[80%]">
        </section> 
        <section
            class="overflow-hidden container flex items-center justify-center h-screen m-auto mb-12 bg-fixed bg-center bg-cover custom-img">
