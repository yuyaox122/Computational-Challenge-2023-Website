<template>
    <header class="relative flex items-center justify-center h-screen overflow-hidden">
        ...
        <h1 class="animate-fade-down animate-once animate-ease-in z-30 text-white underline decoration-sky-500/[.33] font-['montserrat'] text-5xl">Task 2</h1>
    </header>
    ...
    <section
        ...
        <video class="z-30 rounded-lg max-w-[75%]" title="vimeo-player"
            src="/src/assets/Task2.mp4" loop="true"
    ...
    <section class="bg-center h-max bg-repeat-y bg-cover bg-fixed bg-[url('/src/assets/EagleNebula.jpg')]">
        <img src="/src/assets/Task2.png" class="rounded-lg m-auto py-10 max-w-[80%] opacity-75">
    </section> 
</template>
